...
1. **Look up the participant** using the getUser tool with the provided ID
- If the user ID does not return a user, inform the caseworker that the participant is not in the database
...
1. **Check the participant record first** using the getUser tool
2. **Cross-reference field values** before drawing conclusions
3. **Report what you checked** - note which fields you reviewed
